...
void turn_right(float read_start){
    ...
    if(read_start <100 ){ //read_start <110
      while(abs(read_final - read_start)<=80){
      ...
      while(true){
        ...
        else if((angle1 + abs(180 - abs(read_final)))<80){
          analogWrite(enable_r, 255);
          analogWrite(enable_l, 255);
          digitalWrite(motor_r1,HIGH);
          digitalWrite(motor_r2,LOW);
